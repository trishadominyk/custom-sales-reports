...
class PosChargeInvoiceReport(models.AbstractModel):
	_name = 'report.custom_sales_report.report_charge_invoice'
	...
	def render_html(self, docids, data=None):
		...
		return Report.sudo().render('custom_sales_reports.report_charge_invoice', {'docs': self.env['account.invoice'].sudo().browse(ids_to_print)})